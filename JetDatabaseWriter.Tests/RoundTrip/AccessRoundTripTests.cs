...
public sealed class AccessRoundTripTests
{
    ...
    [Fact(Skip = "DAO Compact succeeds but DAO OpenRecordset still rejects writer-created user tables ('Unrecognized database format') — rows dropped during compact. See DaoValidationTests.")]
