...
- `AccessWriterLimitationsTests.SchemaEvolution_ColumnDefinition_ExposesConstraintProperties` updated to include the two new properties in the alphabetical expected list.
