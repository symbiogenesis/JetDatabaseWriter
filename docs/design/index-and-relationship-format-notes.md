...
- DAO creates a Type=8 `MSysObjects` row for the relationship under the relationships pseudo-object (`ParentId = 0x0F000003`) and relationship ACE rows. Writer-created FK compact preservation now emits both.
