...
/// 4 properties match column names. This is the shape the column-projection
/// optimization is meant to accelerate; including it in the baseline so the
/// projection delta is visible.
/// </summary>
