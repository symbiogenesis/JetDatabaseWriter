...
| ACCDB Agile (Access-native) | Access 2010 SP1+, Microsoft 365 (`.accdb`) | Flat Agile header: masked encoding key at page-0 `0x3E`, `EncryptionInfo` length at `0x299`, descriptor at `0x29B`; written by `AccessEncryptionFormat.AccdbAgile` | ECMA-376 §2.3.4.11 PBKDF: SHA-512 + `spinCount` iterations + spec block keys (`0xfea7d2763b4b9e79`, `0xd7aa0f6d3061344e`, `0x146e0be7abacd0d6`) | AES-256-CBC per data page; IV `SHA-512(keyDataSalt || (uint32_le(pageNumber) XOR encodingKey))[:16]` |
